        ...
        while (true /* not glfwWindowShouldClose(window) */) {
                ...
                if(mouse_state == GLFW_PRESS){
                        ...
                        if(dragging){
                                ...
                                render_state.ubo.model = glm::rotate(glm::mat4(1.0f), -(float)x_offset * glm::radians(360.0f), glm::vec3(camera_u));
                                render_state.ubo.model = glm::rotate(glm::mat4(1.0f), -(float)y_offset * glm::radians(360.0f), glm::vec3(camera_v));
                        }
